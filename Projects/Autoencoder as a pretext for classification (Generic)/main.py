...
if __name__ == '__main__':
    ...
    y_pred = model_classifier.predict(X_train, {})
    y_pred = y_pred.apply(lambda y: y.apply(FeedForwardNetwork.__j2_loss_function__, args=(low, high)), axis=1)
    y_train_out = Y_train.copy()['Label'].apply(FeedForwardNetwork.__convert_label_to_result__)
    ...
    y_pred = model_classifier.predict(X_train, None)
    ...
    y_pred = model_classifier.predict(X_test, None)
